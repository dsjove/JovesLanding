...
public struct MotorView<M: MotorProtocol> : View {
	@ObservedObject var motorPower: M.Power
	@ObservedObject var motorCalibration: M.Calibration

	public init(moter: M) {
		self.motorPower = moter.power
		self.motorCalibration = moter.calibration
	}

	public var body: some View {
		Text("Motor").font(.headline).lineLimit(2)
		ScrubView(
